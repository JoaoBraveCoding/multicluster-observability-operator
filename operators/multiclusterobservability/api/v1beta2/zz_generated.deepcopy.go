...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiClusterObservabilityComponentStatus) DeepCopyInto(out *MultiClusterObservabilityComponentStatus) {
	*out = *in
	if in.Grafana != nil {
		in, out := &in.Grafana, &out.Grafana
	...
	if in.ThanosQuery != nil {
		in, out := &in.ThanosQuery, &out.ThanosQuery
		*out = make(PodStatusMap, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
	...
	if in.ThanosQueryFrontend != nil {
		in, out := &in.ThanosQueryFrontend, &out.ThanosQueryFrontend
		*out = make(PodStatusMap, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
	...
	if in.ThanosReceiveController != nil {
		in, out := &in.ThanosReceiveController, &out.ThanosReceiveController
		*out = make(PodStatusMap, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
	...
	if in.ObservatoriumOperator != nil {
		in, out := &in.ObservatoriumOperator, &out.ObservatoriumOperator
		*out = make(PodStatusMap, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
	...
	if in.ThanosReceive != nil {
		in, out := &in.ThanosReceive, &out.ThanosReceive
		*out = make(PodStatusMap, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
	...
	if in.ThanosRule != nil {
		in, out := &in.ThanosRule, &out.ThanosRule
		*out = make(PodStatusMap, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
	...
	if in.ThanosStoreMemcached != nil {
		in, out := &in.ThanosStoreMemcached, &out.ThanosStoreMemcached
		*out = make(PodStatusMap, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
	...
	if in.ThanosStoreShard != nil {
		in, out := &in.ThanosStoreShard, &out.ThanosStoreShard
		*out = make(PodStatusMap, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiClusterObservabilityComponentStatus.
func (in *MultiClusterObservabilityComponentStatus) DeepCopy() *MultiClusterObservabilityComponentStatus {
	if in == nil {
		return nil
	}
	out := new(MultiClusterObservabilityComponentStatus)
	in.DeepCopyInto(out)
	return out
}
